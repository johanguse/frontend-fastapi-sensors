  ...
  return (
    <DropdownUserProfile>
      <Button
        ...
        className={cn(
          focusRing,
          'group flex w-full items-center justify-between rounded-md p-2 text-sm font-medium text-gray-900 hover:bg-gray-100 data-[state=open]:bg-gray-100 hover:dark:bg-gray-400/10 dark:data-[state=open]:bg-gray-400/10'
        )}
      >
  ...
  return (
    <DropdownUserProfile align="end">
      <Button
        ...
        variant="ghost"
        className={cn(
          'group flex items-center rounded-md p-1 text-sm font-medium text-gray-900 hover:bg-gray-100 data-[state=open]:bg-gray-100 hover:dark:bg-gray-400/10 dark:data-[state=open]:bg-gray-400/10'
        )}
      >
        <span
