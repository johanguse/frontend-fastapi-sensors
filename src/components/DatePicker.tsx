    ...
    return (
      <PopoverPrimitives.Trigger asChild>
        ...
        >
          ...
          <span className="flex-1 truncate text-left text-gray-900 dark:text-gray-50">
            {children ? (
              children
            ) : placeholder ? (
        ...
        return (
          <li key={index} className="sm:w-full sm:py-px">
            <button
              ...
              className={cn(
                // base
                'relative w-full truncate rounded border px-2.5 py-1.5 text-left text-base shadow-sm outline-none transition-all sm:border-none sm:py-2 sm:text-sm sm:shadow-none',
                // text color
